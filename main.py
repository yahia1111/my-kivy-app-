...
# تصميم الواجهة الاحترافية مع إضافة كود تشغيل الصوت التلقائي في الخلفية
HTML_TEMPLATE = '''
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .btn-submit { background-color: #2563eb; color: white; border: none; width: 100%; padding: 12px; border-radius: 8px; font-size: 16px; font-weight: bold; cursor: pointer; transition: 0.2s; }
        ...
        .btn { flex: 1; padding: 8px; border: none; border-radius: 6px; font-weight: bold; text-align: center; text-decoration: none; color: white; font-size: 14px; cursor: pointer; }
    ...
    <div class="container">
        ...
        <div class="form-card">
            ...
            <form action="/add" method="POST">
                <div class="form-group">
                    <label>اسم الزبون كاملاً</label>
                    <input type="text" name="name" required>
                </div>
                <div class="form-group">
                    <label>رقم تليفونه للتواصل</label>
                    <input type="text" name="phone" required>
                </div>
                <div class="form-group">
                    <label>عنوانه فين بالظبط؟</label>
                    <input type="text" name="address" required>
                </div>
                <div class="form-group">
                    <label>الميعاد بالتفصيل</label>
                    <input type="text" name="date_time" placeholder="مثال: 2026-05-25 14:30" required>
                </div>
        ...
        {% else %}
            ...
            <div class="appt-card">
                ...
                <p class="time"><b>⏰ ميعاد الزيارة المتحدد:</b> {{ row[4] }}</p>
                
                <div class="btn-container">
                    <a href="tel:{{ row[2] }}" class="btn btn-call">📞 اتصل بالزبون</a>
                    <a href="https://google.com{{ row[3] }}" target="_blank" class="btn btn-map">📍 مكان الزيارة</a>
